...
function makeHeadingIds () { // eslint-disable-line
  var content = document.querySelector('.js-toc-content')
  var headings = content.querySelectorAll('h2, h3, h4, h5')
  var headingMap = {}

  // insert anchor link for hover
  var anchor = '<a href="#customizing" class="absolute after:hash opacity-0 group-hover:opacity-100" style="margin-left:-1em;padding-right:0.5em;box-shadow:none;color:#a1a1aa" aria-label="Anchor"></a>';
